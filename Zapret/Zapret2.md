...
**[[Домашняя страница Zapret 2|[[Домашняя страница Zapret 2|Zapret 2]]** — инструмент для обхода DPI (Deep Packet Inspection) под авторством [bol-van](https://github.com/bol-van/zapret2) — систем глубокого анализа трафика, которые используются для блокировки сайтов и сервисов. В России это ТСПУ (технические средства противодействия угрозам).
