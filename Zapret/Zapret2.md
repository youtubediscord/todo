...
**Zapret 2** — инструмент для обхода DPI (Deep Packet Inspection) — систем глубокого анализа трафика, которые используются для блокировки сайтов и сервисов. В России это ТСПУ (технические средства противодействия угрозам).
