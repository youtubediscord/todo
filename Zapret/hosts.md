...
Вы можете купить [[Zapret/premium|премиум]] чтобы использовать KVN для [[android|Android]] устройств (*или редактировать `hosts файл` через root права, имея, например, AdWay*), а для ПК проще всего и надёжнее будет использовать редактор файла hosts через [[guide|Zapret GUI]].
