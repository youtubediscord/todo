...
Домены: делаются на уровне winws/winws2 через [[filter#10. **`--hostlist`** - Включающий список доменов|--hostlist]] / [[filter#11. **`--hostlist-domains`** - Фиксированный список доменов|--hostlist-domains]].
