...
9. [Шаг 6: SSH через туннель](#9-шаг-6-ssh-через-туннель)
10. [Шаг 7: DNS-разделение RU/Default](#10-шаг-7-dns-разделение-rudefault)
11. [Итоговая архитектура](#11-итоговая-архитектура)
12. [Рекомендация по транспорту](#12-рекомендация-по-транспорту)
...
## 10. Шаг 7: DNS-разделение RU/Default
...
- [ ] SSH слушает только на выходном IP (или 127.0.0.1)
